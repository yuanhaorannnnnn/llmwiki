...
updated: 2026-05-18
type: query
tags: [article, claude-code, agent, architecture, methodology, enterprise, skills, plugins, lsp]
sources: [raw/articles/20260518-how-claude-code-works-in-large-codebases-best-practices-and-.md]
...
**关键 insight**：如果一个函数两周前被改名，RAG 可能返回旧名且无提示。Agentic search 每次都是读当前文件系统。
...
- [[raw/articles/20260518-how-claude-code-works-in-large-codebases-best-practices-and-.md]]
